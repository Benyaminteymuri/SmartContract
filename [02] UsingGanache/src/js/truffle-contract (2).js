...
throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}
return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
(function (global){
    ...
    if (network_name == "default") {
      if (ignore_default_network == true ) {
        ...
        throw new Error(soljs_abstraction.contract_name +
          "has legacy 'default' network artifacts stored within it. Generally these artifacts" +
          "were a result of running Truffle on a development environment" +
          "-- in order to store contracts with truffle-contract,all networks must have an identified id." +
          "If you're sure this default network represents your development environment, you can ignore processing" +
          "of the default network by passing `true` as the second argument to this function. However,"+
          "if you think this network represents artifacts you'd like to keep (i.e., addresses deployed to the main network)," +
          "you'll need to edit your .sol.js file yourself and change the default network id to be the id of your desired network." +
          "For most people, ignoring the default network is the correct option.");
      }
    }
